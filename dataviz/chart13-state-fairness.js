...
import { loadData, groupBy, sumBy, formatPercent, formatNumber, COLORS } from "./core.js";
...
export default function render(container, props = {}) {
  ...
  async function init() {
    ...
    try {
      ...
      subtitle.innerHTML = `${overAllocated} states receive more than their need share, ${underAllocated} receive less. Delta labels show gap.`;
