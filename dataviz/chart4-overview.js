...
import { loadData, groupBy, sumBy, meanBy, formatCurrency, formatNumber, THEME_COLORS, COLORS } from "./core.js";
...
export default function render(container, props = {}) {
  ...
  async function init() {
    ...
    try {
      ...
      summary.innerHTML = `<strong>${topTheme.theme}</strong> leads with ${formatCurrency(topTheme.budget, 0)}M budget, reaching ${formatNumber(topTheme.beneficiaries / 1000, 0)}K beneficiaries at ${formatCurrency(topTheme.cost_per_beneficiary, 0)}/person.`;
