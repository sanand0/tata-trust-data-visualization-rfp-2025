...
import { COLORS, formatPercent, loadData } from "./core.js";
  ...
  async function init() {
    ...
    try {
      ...
      const waterfallData = [
        ...
        {
          label: "+Standups",
          value: withStandups - withTemplate,
          isTotal: false,
          start: withTemplate,
          end: withStandups,
        },
        {
          label: "+Early Warning",
          value: withEarlyWarning - withStandups,
          isTotal: false,
          start: withStandups,
          end: withEarlyWarning,
        },
        {
          label: "+Site Visits",
          value: withVisits - withEarlyWarning,
          isTotal: false,
          start: withEarlyWarning,
          end: withVisits,
        },
      ...
      chart = Plot.plot({
        ...
        marks: [
          ...
          // Connector lines
          Plot.link(
            waterfallData.slice(0, -1).map((d, i) => ({
              x1: d.label,
      ...
      insight.innerHTML = `Implementing all operational levers increases KPI attainment by <strong>${
        formatPercent(totalLift, 1)
      }</strong>.`;
