...
import { loadData, groupBy, meanBy, formatNumber, COLORS } from "./core.js";
...
export default function render(container, props = {}) {
  ...
  async function init() {
    ...
    try {
      ...
      insight.innerHTML = `High-need districts (deciles 8-10) have an average coverage gap of <strong>${formatNumber(avgGap, 2)}/1K</strong>. Red area shows shortfall.`;
