...
import { loadData, formatCurrency, formatNumber, THEME_COLORS, COLORS } from "./core.js";
...
export default function render(container, props = {}) {
  ...
  async function init() {
    ...
    try {
      ...
      insight.innerHTML = `Large grants (>${formatCurrency(budgetThreshold, 0)}M) show lower efficiency. Consider splitting ${whales.length} underperforming grants.`;
