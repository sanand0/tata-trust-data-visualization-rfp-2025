...
function initBackToTop() {
  ...
  button.style.cssText = 'bottom: 2rem; right: 2rem; width: 50px; height: 50px; z-index: 1000; opacity: 0; transition: opacity 0.3s ease;';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  console.log('%cCheck out the process at: https://github.com/sanand0/tata-trust-data-visualization-rfp-2025', 'font-size: 12px; color: #d0362d;');
});
